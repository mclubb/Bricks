...
public class BBRenderer implements Renderer {
	...
	mPaddle.Update();
        ...
        RectF boundsRect = new RectF(0, 100, 600, 800);
	...
	border = new Border(300, 55, 0, 600, 8, textures[0], 201/512.0f, 47/512.0f, 501/512.0f, 79/512.0f, mContext); 
        background = new Sprite(300, 400, -1, 600, 800, textures[1], 0, 0, 1, 1, mContext);
        mPaddle = new Paddle(100, 775, 0, 100, 18, textures[0], 0, 443 / 512.0f, 78 / 512.0f, 463 / 512.0f, mContext);
        mBall = new Ball(100, 760, 0, 15, 15, textures[0], 330 / 512.0f, 490 / 512.0f, 345 / 512.0f, 505 / 512.0f, mContext);
    }
